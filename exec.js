...
function createSOfButton(title, lucideID, setOnClick){
  var createOfButton=document.createElement('button');
  createOfButton.setAttribute("class", "ofbutton");
  createOfButton.setAttribute("onClick", setOnClick);
...
function createS2OfButton(title, lucideID, setOnClick){
  var createOfButton=document.createElement('button');
  createOfButton.setAttribute("class", "ofbutton");
  createOfButton.setAttribute("onClick", setOnClick);
...
createSOfButton('Close', 'x', "var rem = document.getElementById('OFmenu'); rem.remove();")
createS2OfButton('Shrink', 'minimize-2', "var rem = document.getElementById('OFmenu'); rem.remove();var maxbutton = document.createElement('button');maxbutton.id='closeOfEmbed';maxbutton.style = 'position:fixed;left:1%;top:1%;z-index:50001;border:none;border-radius:10px;background-color:#ffffff;position:absolute;background-repeat:no-repeat;background-size:20px;background-position:center;width:30px;height:30px;background-image:url(https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/maximize-2.svg)';maxbutton.onclick = function() {window.s0=document.createElement('script');window.s0.setAttribute('type','text/javascript');window.s0.setAttribute('src','https://alofsto.github.io/AlofstoDashboard/exec.js');document.getElementsByTagName('body')[0].appendChild(window.s0);this.remove();};document.body.appendChild(maxbutton);")
