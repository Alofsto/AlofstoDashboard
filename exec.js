...
createOfButton('Embed', 'maximize', "var ofembed = document.createElement('iframe'); ofembed.id = 'ofEmbed'; ofembed.src=prompt('What site do you want to visit?', 'https://');ofembed.style='top:5%;left:5%;right:5%;bottom:5%;position:fixed;width:90%;height:90%;z-index:99999999999;boxShadow:rgba(50, 50, 93, 0.25) 0px 30px 60px -12px, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px'; document.body.appendChild(ofembed);var closebutton = document.createElement('button');closebutton.id='closeOfEmbed';closebutton.style = 'position:fixed;right:2.5%;top:2.5%;z-index:100000000000;border:none;border-radius:10px;background-color:#ffffff;position:absolute;background-repeat:no-repeat;background-size:25px;background-position:center;width:30px;height:30px;background-image:url(https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/x.svg)';closebutton.onclick = function() {var rem = document.getElementById('ofEmbed'); rem.remove(); this.remove();};document.body.appendChild(closebutton);");
